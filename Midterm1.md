...
* Example: let A be an m x n matrix. If Ax=b has no solutions, is it true that Ax=0 has infinitely many solutions when n>m? Note that n is the number of unknowns and m is the number of equations.
